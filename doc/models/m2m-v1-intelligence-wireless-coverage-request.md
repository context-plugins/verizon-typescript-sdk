...
```ts
import { M2mV1IntelligenceWirelessCoverageRequest } from 'verizonlib';

const m2mV1IntelligenceWirelessCoverageRequest: M2mV1IntelligenceWirelessCoverageRequest = {
