...
| `maxNumberOfDevices` | `number \| undefined` | Optional | **Constraints**: `>= 0`, `<= 500` |
| `largestDeviceIdSeen` | `bigint \| undefined` | Optional | **Constraints**: `>= 0`, `<= 0` |

## Example

```ts
import { AccountDeviceListRequest } from 'verizonlib';

const accountDeviceListRequest: AccountDeviceListRequest = {
