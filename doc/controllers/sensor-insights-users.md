...
```ts
const sensorInsightsUsersController = new SensorInsightsUsersController(client);
```
...
try {
  const response = await sensorInsightsUsersController.sensorInsightsCreateUserRequest(body);
...
try {
  const response = await sensorInsightsUsersController.sensorInsightsDeleteUser(deleterequestpayload);
...
try {
  const response = await sensorInsightsUsersController.sensorInsightsUpdateUserRequest(body);
...
try {
  const response = await sensorInsightsUsersController.sensorInsightsListUserRequest(body);
