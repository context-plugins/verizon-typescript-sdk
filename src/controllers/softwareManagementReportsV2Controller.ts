...
} from '../models/deviceSoftwareUpgrade.js';
import {
  SoftwarePackage,
  softwarePackageSchema,
} from '../models/softwarePackage.js';
import {
  V2AccountDeviceList,
  v2AccountDeviceListSchema,
} from '../models/v2AccountDeviceList.js';
import {
  V2CampaignDevice,
  v2CampaignDeviceSchema,
} from '../models/v2CampaignDevice.js';
import {
  V2CampaignHistory,
  v2CampaignHistorySchema,
} from '../models/v2CampaignHistory.js';
