...
} from '../models/dtoGetNetworkHealthScoreResponse.js';
import {
  DtoHealthScoreSummary,
  dtoHealthScoreSummarySchema,
} from '../models/dtoHealthScoreSummary.js';
...
export class SensorInsightsHealthScoreController extends BaseController {
  /**
