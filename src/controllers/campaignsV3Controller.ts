...
import { Campaign, campaignSchema } from '../models/campaign.js';
import {
  CampaignFirmwareUpgrade,
  campaignFirmwareUpgradeSchema,
} from '../models/campaignFirmwareUpgrade.js';
import {
  FirmwareCampaign,
  firmwareCampaignSchema,
} from '../models/firmwareCampaign.js';
import {
  FotaV3SuccessResult,
  fotaV3SuccessResultSchema,
} from '../models/fotaV3SuccessResult.js';
import {
  V3AddOrRemoveDeviceRequest,
  v3AddOrRemoveDeviceRequestSchema,
} from '../models/v3AddOrRemoveDeviceRequest.js';
import {
  V3AddOrRemoveDeviceResult,
  v3AddOrRemoveDeviceResultSchema,
} from '../models/v3AddOrRemoveDeviceResult.js';
import {
  V3ChangeCampaignDatesRequest,
  v3ChangeCampaignDatesRequestSchema,
} from '../models/v3ChangeCampaignDatesRequest.js';
import { string } from '../schema.js';
import { BaseController } from './baseController.js';
import { FotaV3ResultError } from '../errors/fotaV3ResultError.js';
