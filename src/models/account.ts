...
import { IPPool, iPPoolSchema } from './iPPool.js';
import { ServicePlan, servicePlanSchema } from './servicePlan.js';
...
export const accountSchema: Schema<Account> = lazy(() =>
  object({
    ...
    iPPools: ['iPPools', optional(array(iPPoolSchema))],
    servicePlans: ['servicePlans', optional(array(servicePlanSchema))],
  })
);
