...
import {
  ...
  altitudeConfidenceEnumSchema,
} from './altitudeConfidenceEnum.js';
...
export const altitudeSchema: Schema<Altitude> = object({
  altitudeValue: ['altitudeValue', optional(number())],
  altitudeConfidence: [
    'altitudeConfidence',
    optional(altitudeConfidenceEnumSchema),
  ],
});
