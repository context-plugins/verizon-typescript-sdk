...
import { V3LicenseDevice, v3LicenseDeviceSchema } from './v3LicenseDevice.js';
...
export const v3LicenseSummarySchema: Schema<V3LicenseSummary> = lazy(() =>
  object({
    ...
    deviceList: ['deviceList', optional(array(v3LicenseDeviceSchema))],
  })
);
