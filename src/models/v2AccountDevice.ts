...
import { V2SoftwareInfo, v2SoftwareInfoSchema } from './v2SoftwareInfo.js';
...
export const v2AccountDeviceSchema: Schema<V2AccountDevice> = lazy(() =>
  object({
    ...
    softwareList: ['softwareList', array(v2SoftwareInfoSchema)],
