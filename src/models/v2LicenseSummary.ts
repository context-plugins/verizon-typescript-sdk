...
import { V2LicenseDevice, v2LicenseDeviceSchema } from './v2LicenseDevice.js';
...
export const v2LicenseSummarySchema: Schema<V2LicenseSummary> = lazy(() =>
  object({
    ...
    deviceList: ['deviceList', optional(array(v2LicenseDeviceSchema))],
  })
);
