...
export const deviceGroupUpdateRequestSchema: Schema<DeviceGroupUpdateRequest> = lazy(
  () =>
    object({
      devicesToAdd: ['devicesToAdd', optional(array(deviceIdSchema))],
      devicesToRemove: ['devicesToRemove', optional(array(deviceIdSchema))],
