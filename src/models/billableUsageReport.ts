...
import { ServiceUsage, serviceUsageSchema } from './serviceUsage.js';
...
export const billableUsageReportSchema: Schema<BillableUsageReport> = lazy(() =>
  object({
    ...
    primaryAccount: ['PrimaryAccount', optional(serviceUsageSchema)],
    managedAccounts: ['ManagedAccounts', optional(array(serviceUsageSchema))],
  })
);
