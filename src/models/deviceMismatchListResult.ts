...
import {
  MismatchedDevice,
  mismatchedDeviceSchema,
} from './mismatchedDevice.js';
...
export const deviceMismatchListResultSchema: Schema<DeviceMismatchListResult> = lazy(
  () =>
    object({ devices: ['devices', optional(array(mismatchedDeviceSchema))] })
);
