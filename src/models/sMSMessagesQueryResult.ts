...
import { SMSMessage, sMSMessageSchema } from './sMSMessage.js';
...
export const sMSMessagesQueryResultSchema: Schema<SMSMessagesQueryResult> = lazy(
  () =>
    object({
      hasMoreData: ['hasMoreData', optional(boolean())],
      messages: ['messages', optional(array(sMSMessageSchema))],
    })
);
