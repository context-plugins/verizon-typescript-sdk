...
import { DateFilter, dateFilterSchema } from './dateFilter.js';
...
export const deviceMismatchListRequestSchema: Schema<DeviceMismatchListRequest> = lazy(
  () =>
    object({
      filter: ['filter', dateFilterSchema],
