...
import { SMSNumber, sMSNumberSchema } from './sMSNumber.js';
...
export const triggerNotificationSchema: Schema<TriggerNotification> = lazy(() =>
  object({
    ...
    smsNumbers: ['smsNumbers', optional(array(sMSNumberSchema))],
