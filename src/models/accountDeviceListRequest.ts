...
} from './accountDeviceListFilter.js';
...
export const accountDeviceListRequestSchema: Schema<AccountDeviceListRequest> = lazy(
  () =>
    object({
      accountName: ['accountName', optional(string())],
      deviceId: ['deviceId', optional(deviceIdSchema)],
      filter: ['filter', optional(accountDeviceListFilterSchema)],
