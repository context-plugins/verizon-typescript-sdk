...
} from './deviceFilterWithoutAccount.js';
...
export const deviceSuspensionStatusRequestSchema: Schema<DeviceSuspensionStatusRequest> = lazy(
  () =>
    object({
      deviceIds: ['deviceIds', optional(array(deviceIdSchema))],
      filter: ['filter', optional(deviceFilterWithoutAccountSchema)],
