...
import { Fields1, fields1Schema } from './fields1.js';
...
export const searchDeviceByPropertyResponseSchema: Schema<SearchDeviceByPropertyResponse> = lazy(
  () =>
    object({
      ...
      fields: ['fields', optional(fields1Schema)],
