...
} from './createTargetRequestFields.js';
import {
  TargetAuthentication,
  targetAuthenticationSchema,
} from './targetAuthentication.js';
...
export const createTargetRequestSchema: Schema<CreateTargetRequest> = lazy(() =>
  object({
    accountidentifier: ['accountidentifier', optional(accountIdentifierSchema)],
