...
import { DeviceFilter, deviceFilterSchema } from './deviceFilter.js';
import { PlaceOfUse, placeOfUseSchema } from './placeOfUse.js';
...
export const goToStateRequestSchema: Schema<GoToStateRequest> = lazy(() =>
  object({
    serviceName: ['serviceName', string()],
    stateName: ['stateName', string()],
    servicePlan: ['servicePlan', string()],
    mdnZipCode: ['mdnZipCode', string()],
    devices: ['devices', optional(array(accountDeviceListSchema))],
    filter: ['filter', optional(deviceFilterSchema)],
    ...
    primaryPlaceOfUse: ['primaryPlaceOfUse', optional(placeOfUseSchema)],
  })
);
