...
} from './accountLicenseDeviceListItem.js';
...
export const accountLicenseInfoSchema: Schema<AccountLicenseInfo> = lazy(() =>
  object({
    ...
    deviceList: [
      'deviceList',
      optional(array(accountLicenseDeviceListItemSchema)),
    ],
  })
);
