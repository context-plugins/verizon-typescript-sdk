...
export const deviceProvisioningHistoryListResultSchema: Schema<DeviceProvisioningHistoryListResult> = lazy(
  () =>
    object({
      hasMoreData: ['hasMoreData', optional(boolean())],
      provisioningHistory: [
        'provisioningHistory',
        optional(array(provisioningHistorySchema)),
      ],
    })
);
