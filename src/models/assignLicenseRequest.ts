...
export const assignLicenseRequestSchema: Schema<AssignLicenseRequest> = lazy(
  () =>
    object({
      accountName: ['accountName', optional(string())],
      devices: ['devices', optional(array(licenseDeviceListSchema))],
